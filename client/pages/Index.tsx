      ...
      <div className="px-5 md:px-8 mb-6">
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            >
              <span className="text-orange-accent font-crimson text-lg font-semibold">따뜻한 햇살</span>
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="transform rotate-180">
                <path d="M15 7.5L10 12.5L5 7.5" stroke="#EA8C4B" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          </div>
          <span className="text-grey-900 font-crimson text-lg font-bold">님</span>
        </div>
      </div>
