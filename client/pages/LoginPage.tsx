    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <div className="w-full max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl px-5 space-y-4 md:space-y-6">
        ...
        <div className="flex items-center justify-center pt-8 pb-4">
          ...
          <span className="px-4 text-text-gray font-crimson text-base md:text-lg">간편 로그인</span>
          <div className="flex-1 h-px bg-border-gray"></div>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            <img 
              ...
              className="w-6 h-6"
            />
            <span className="text-gray-800 font-crimson text-base md:text-lg font-bold">카카오로 로그인</span>
          </button>
          ...
          >
            ...
            <span className="text-gray-800 font-crimson text-base md:text-lg font-bold">네이버로 로그인</span>
          </button>
          ...
          >
            ...
            <span className="text-gray-800 font-crimson text-base md:text-lg font-bold">구글로 로그인</span>
          </button>
        </div>
      </div>
    </div>
