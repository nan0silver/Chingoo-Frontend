...
export default function ConnectingCallPage({ selectedCategory, onCancel }: ConnectingCallPageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between items-center px-6 py-3 h-11 md:hidden">
        ...
        <div className="flex items-center gap-1">
          ...
          <svg width="15" height="11" viewBox="0 0 15 11" fill="none" className="ml-2">
            <path d="M7.5 3.5C10.5 3.5 13 5.5 13 8H12C12 6.5 9.5 5 7.5 5S3 6.5 3 8H2C2 5.5 4.5 3.5 7.5 3.5Z" fill="white"/>
          </svg>
          {/* Battery */}
      ...
      <div className="flex justify-center mt-16">
        <h1 className="text-white font-pretendard text-4xl font-medium">통화 연��� 중</h1>
      </div>
